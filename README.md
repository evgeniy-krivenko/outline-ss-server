...
```
go test -cpuprofile cpu.prof -memprofile mem.prof -bench . -benchmem -run=^$ github.com/evgeniy-krivenko/outline-ss-server/shadowsocks
```
...
We use [GoReleaser](https://goreleaser.com/) to build and upload binaries to our [GitHub releases](https://github.com/evgeniy-krivenko/outline-ss-server/releases).
...
- Build and upload:
  ...
  goreleaser
  ```
- Go to https://github.com/evgeniy-krivenko/outline-ss-server/releases, review and publish the release.
